...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <a style="padding-right: 2em;" class="navbar-brand" href="/elibrary/home">E-Library : its a basic demo webapp using Spring Boot applications</a>
    ...
    <p>&nbsp;</p>
    <div class="container">
        <h3>Welcome to Laith Nassar E-Library system</h3>
        <hr/>
